      ...
      <div id="features" className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Card className="shadow-card hover:shadow-glow transition-smooth">
            <CardHeader>
              <div className="gradient-primary p-3 rounded-full w-fit mb-4">
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Badge variant="outline">4+ Passengers</Badge>
          ...
          <Card className="shadow-card hover:shadow-glow transition-smooth">
            <CardHeader>
              ...
              <CardTitle>Boda-Boda Service</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <div className="space-y-2">
                <Badge variant="outline">Traffic Beating</Badge>
                <Badge variant="outline">Quick Rides</Badge>
          ...
          <Card className="shadow-card hover:shadow-glow transition-smooth">
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Badge variant="outline">ETA Updates</Badge>
        ...
        {/* CTA Section */}
        <Card className="text-center gradient-primary text-primary-foreground shadow-glow">
